...
#define TRUE 1
#define FALSE 0
  Eigen::Matrix<BOOL,Dynamic,1> as_lx = Eigen::Matrix<BOOL,Dynamic,1>::Constant(n,1,FALSE);
  Eigen::Matrix<BOOL,Dynamic,1> as_ux = Eigen::Matrix<BOOL,Dynamic,1>::Constant(n,1,FALSE);
  Eigen::Matrix<BOOL,Dynamic,1> as_ieq = Eigen::Matrix<BOOL,Dynamic,1>::Constant(Aieq.rows(),1,FALSE);
  ...
  while(true)
  {
    ...
    {
      // NO DUPES!
      Eigen::Matrix<BOOL,Dynamic,1> fixed = Eigen::Matrix<BOOL,Dynamic,1>::Constant(n,1,FALSE);
