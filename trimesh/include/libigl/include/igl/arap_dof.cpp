  ...
  ArapDOFData<LbsMatrixType, SSCALAR> & data)
{
  ...
  typedef Eigen::Matrix<SSCALAR, Dynamic, Dynamic> MatrixXS;
  ...
  )
{
  ...
  Eigen::Matrix<SSCALAR,Dynamic,1> B_eq_SSCALAR = B_eq.cast<SSCALAR>();
  Eigen::Matrix<SSCALAR,Dynamic,1> B_eq_fix_SSCALAR;
  Eigen::Matrix<SSCALAR,Dynamic,1> L0SSCALAR = L0.cast<SSCALAR>();
